...
python run_retrieval.py --image_folder=$image_folder --dataset_file="./data/xtd.json"\
  ...
  --out_file="results/retrieval/xtd/st-mbert-vitb32"
...
python run_retrieval.py --image_folder=$image_folder --dataset_file="./data/xtd.json"\
  ...
  --out_file="results/retrieval/xtd/mclip-mbert-vitb32"

python run_retrieval.py --image_folder=$image_folder --dataset_file="./data/xtd.json"\
  --num_workers=4 --batch_size=512 \
  --source="m-clip" --from_pretrained="M-CLIP/XLM-Roberta-Large-Vit-B-32" \
  --out_file="results/retrieval/xtd/mclip-xlmrl-vitb32"

python run_retrieval.py --image_folder=$image_folder --dataset_file="./data/xtd.json"\
  --num_workers=4 --batch_size=512 \
  --source="m-clip" --from_pretrained="M-CLIP/XLM-Roberta-Large-Vit-B-16Plus" \
  --out_file="results/retrieval/xtd/mclip-xlmrl-vitb16plus"

python run_retrieval.py --image_folder=$image_folder --dataset_file="./data/xtd.json"\
  --num_workers=4 --batch_size=512 \
  --source="m-clip" --from_pretrained="M-CLIP/XLM-Roberta-Large-Vit-L-14" \
  --out_file="results/retrieval/xtd/mclip-xlmrl-vitl14"
...
python run_retrieval.py --image_folder=$image_folder --dataset_file="./data/xtd.json"\
  ...
  --out_file="results/retrieval/xtd/altclip-xlmrl-vitl14"
