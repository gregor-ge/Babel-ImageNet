...
xlmr_langs = ['NE', 'ID', 'DE', 'NL', 'AF', 'HE', 'SQ', 'UZ', 'KN', 'KU', 'TA', 'LV', 'KO', 'UG', 'BR', 'EL', 'SU', 'KK', 'SK', 'GL', 'OM', 'FA', 'JV', 'CS', 'LO', 'HY', 'XH', 'HR', 'SO', 'GU', 'AM', 'AR', 'SA', 'CA', 'IS', 'IT', 'SV', 'GA', 'BG', 'VI', 'SD', 'UR', 'KM', 'PL', 'HU', 'SR', 'FR', 'HI', 'FY', 'ET', 'BS', 'SW', 'AZ', 'MK', 'ES', 'MN', 'JA', 'TL', 'TR', 'GD', 'RO', 'MG', 'MR', 'SL', 'PT', 'LT', 'NO', 'YI', 'UK', 'KY', 'KA', 'BN', 'OR', 'MY', 'EN', 'PS', 'FI', 'ZH', 'DA', 'ML', 'BE', 'EO', 'HA', 'EU', 'AS', 'TE', 'TH', 'CY', 'SI', 'RU', 'LA', 'PA', 'MS']
...
def get_babel_imagenet(args, model):
    image_dataset = torchvision.datasets.ImageNet(args.imagenet_folder, split="val", loader=Image.open, transform=model.transform)


    text_collate = model.tokenize
    text_datasets = []

    # if args.languages == "298":
    babel_imagenet = json.load(open(os.path.join(args.babelimagenet_folder, f"babel_imagenet-298.json"), "r", encoding="utf-8"))
    # else:
    #     babel_imagenet = json.load(open(os.path.join(args.babelimagenet_folder, f"babel_imagenet.json"), "r", encoding="utf-8"))

    if args.languages == "xlmr":
        languages = xlmr_langs
    elif args.languages == "298":
        languages = list(babel_imagenet.keys())
    else:
    ...
    for prompt_name in prompt_names:
        ...
        if prompt_name == "label":
            ...
            lang_prompts = json.load(open(os.path.join(args.babelimagenet_folder, f"{prompt_name}.json"), "r", encoding="utf-8"))
